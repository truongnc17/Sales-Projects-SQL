...
;
CREATE TABLE Task.DBO.DISCOUNT
	(
	MUC_TOI_THIEU FLOAT,
	MUC_TOI_DA FLOAT,
...
LEFT JOIN Task..BANHANG_201906 B
	ON A.CUS_ID = B.CUS_ID
WHERE B.CUS_ID IS NULL
UNION
SELECT A.CUS_ID
FROM Task..BANHANG_201906 A
LEFT JOIN Task..BANHANG_201904 B
	ON A.CUS_ID = B.CUS_ID
WHERE B.CUS_ID IS NULL
